...
func (e *Email) Send(addr string, a smtp.Auth) error {
	...
	return smtp.SendMail(addr, a, fields.From, fields.To, fields.Msg)
}

// Fields ready to be passed, for example, to net/smtp.SendMail
type Fields struct {
	From string
	To   []string
	Msg  []byte
...
func (e *Email) ExtractFields() (*Fields, error) {
	...
	return &Fields{From: from.Address, To: to, Msg: raw}, nil
}
